...
/**
 * Event class to indicate outcome of repo verification
 */
class VerifyRepositoryEvent extends RepositoryEvent {
    
    def VerifyRepositoryEvent(source, Repository repo, boolean isSuccess,
